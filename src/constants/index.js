...
export const ADD_BUY_ONE_GET_ONE_FREE_PROMOTION = 'ADD_BUY_ONE_GET_ONE_FREE_PROMOTION';
export const REMOVE_BUY_ONE_GET_ONE_FREE_PROMOTION = 'REMOVE_BUY_ONE_GET_ONE_FREE_PROMOTION';
...
export const LIST_DELIVERY_ZONE_SUCCESS_FOR_OPEN_USER = 'LIST_DELIVERY_ZONE_SUCCESS_FOR_OPEN_USER';
...
export const LIST_RESTAURANT_CUSTOMER_SUCCESS = 'LIST_RESTAURANT_CUSTOMER_SUCCESS';
...
export const UPDATE_ORDER_SHOW_CHANGE_DELIVERY_TIME_BTN = 'UPDATE_ORDER_SHOW_CHANGE_DELIVERY_TIME_BTN';
export const FETCH_MENU_FOR_ITEM_SETTING_SUCCESS = 'FETCH_MENU_FOR_ITEM_SETTING_SUCCESS';
export const FETCH_MENU_FOR_ITEM_SETTING_FAIL = 'FETCH_MENU_FOR_ITEM_SETTING_FAIL';
...
export const LIST_API_KEY_MANAGEMENT_SUCCESS = 'LIST_API_KEY_MANAGEMENT_SUCCESS';
// Action for reducer
